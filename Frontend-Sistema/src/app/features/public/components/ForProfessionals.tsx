          ...
          <div className="relative z-10 px-12 py-20 max-w-full">
            <div className="text-white max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button type="button" className="bg-white text-teal-600 font-bold py-2.5 px-6 rounded-full hover:bg-gray-100 transition-colors inline-flex items-center justify-center gap-2 text-sm">
                  Registrarme como Profesional
                </button>

                <button type="button" className="border-2 border-white text-white font-bold py-2.5 px-6 rounded-full hover:bg-white/10 transition-colors inline-flex items-center justify-center gap-2 text-sm">
                  Ver el Directorio
                </button>
              </div>
            </div>
